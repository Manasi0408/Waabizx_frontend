...
export function mergeChatMessages(primary, secondary) {
  ...
  return {
    ...
    mediaId: a.mediaId || b.mediaId || null,
    messageType: a.messageType || b.messageType || a.mediaType || b.mediaType || null,
    mediaType: a.mediaType || b.mediaType || a.messageType || b.messageType || null,
